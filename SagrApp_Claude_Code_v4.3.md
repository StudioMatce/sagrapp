...
│   ├── admin-menu.html       # Gestione menu (piatti, prezzi, casse)
...
| PUT | /api/menu/:id | Modifica piatto (prezzo, nome, disponibilità, composizione, casse) |
...
### 5.14 — Componente: Gestione Menu (public/admin-menu.html)

Pagina admin per configurare il menu della sagra: piatti, prezzi, disponibilità per cassa. Le modifiche si applicano in tempo reale — le casse vedono subito i cambiamenti.
...
╠══════════════════════════════════════════════════════════════╣
║                                                              ║
║  [PRIMI] [SECONDI] [CONTORNI] [BEVANDE] [SPECIALI] [COND.] ║
║                                                              ║
║  PRIMI                                                       ║
║  ┌──────────────────────────────────────────────────────┐   ║
║  │ Gnocchi al ragù    €[5,50]  ✅ Gen  ☐ Bar  ☐ Cas  │ ✏️🗑║
║  │ Gnocchi burro      €[5,50]  ✅ Gen  ☐ Bar  ☐ Cas  │ ✏️🗑║
║  │ Pasta al ragù      €[4,50]  ✅ Gen  ☐ Bar  ☐ Cas  │ ✏️🗑║
║  │ Pasta in bianco    €[4,50]  ✅ Gen  ☐ Bar  ☐ Cas  │ ✏️🗑║
║  └──────────────────────────────────────────────────────┘   ║
║                                                              ║
║  SECONDI                                                     ║
║  ┌──────────────────────────────────────────────────────┐   ║
║  │ Costicine polenta  €[7,30]  ✅ Gen  ☐ Bar  ☐ Cas  │ ✏️🗑║
║  │  └ Composizione: 3 costicine + 1 polenta            │    ║
║  │ Salsiccia polenta  €[6,80]  ✅ Gen  ☐ Bar  ☐ Cas  │ ✏️🗑║
║  │  └ Composizione: 2 salsicce + 1 polenta             │    ║
║  │ Grigliata mista    €[11,00] ✅ Gen  ☐ Bar  ☐ Cas  │ ✏️🗑║
║  │  └ Composizione: 2 costicine + 1 salsiccia          │    ║
║  │    + 0.5 sovracoscia + 1 polenta                    │    ║
║  └──────────────────────────────────────────────────────┘   ║
║                                                              ║
║  SPECIALI                                                    ║
║  ┌──────────────────────────────────────────────────────┐   ║
║  │ Pesce fritto  €[13,00]  📅 10/05  ✅ Gen  ☐ Bar   │ ✏️🗑║
║  │ Coniglio      €[15,00]  📅 11/05  ✅ Gen  ☐ Bar   │ ✏️🗑║
║  │ ...                                                  │    ║
║  └──────────────────────────────────────────────────────┘   ║
║                                                              ║
╚══════════════════════════════════════════════════════════════╝
...
| **Modifica nome** | Tap su ✏️ → apre form di modifica |
| **Disponibilità casse** | Checkbox: Cassa Generale / Cassa Bar / Cassa Casetta — definisce in quali casse il piatto appare |
...
| **Composizione pezzi** | Per i piatti griglia: mostra/modifica la scomposizione in pezzi singoli |
| **Elimina** | Pulsante 🗑 con conferma — rimuove il piatto dal menu |

**Aggiungere un nuovo piatto (pulsante [+ Nuovo]):**

Form con i campi:
- Nome piatto
- Prezzo
- Categoria (primo / secondo / contorno / bevanda / speciale / condimento)
- Postazione preparazione (cucina / piastra / griglia / polenta / bar / speciali)
- Casse disponibili (checkbox)
- Composizione pezzi (solo per piatti griglia): quanti costicine, salsicce, sovracoscia, pastin, polenta, patate
- Data disponibilità (solo per piatti speciali)

**Comportamento:**
- Tab per categoria in alto per filtrare velocemente
- Le modifiche al prezzo e alla disponibilità si salvano in tempo reale (nessun pulsante "Salva" globale)
