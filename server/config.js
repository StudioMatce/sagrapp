module.exports = {
  ...
  MENU: [
    ...
    { id: 'gnocchi_ragu', name: 'Gnocchi al ragù', price: 5.50, category: 'primo', station: 'cucina', print_to: ['cibo'],
      initial_stock: 500, alert_threshold: 15 },
    ...
    { id: 'pasta_bianco', name: 'Pasta in bianco', price: 4.50, category: 'primo', station: 'cucina', print_to: ['cibo'],
      initial_stock: 500, alert_threshold: 10 },

    // SECONDI — PIASTRA
    { id: 'formaggio_polenta', name: 'Formaggio cotto con polenta', price: 6.50, category: 'secondo', station: 'piastra', print_to: ['cibo'],
      composition: { polenta: 1 }, initial_stock: 500, alert_threshold: 15 },
    ...
    { id: 'salsiccia_polenta', name: 'Salsiccia con polenta', price: 7.00, category: 'secondo', station: 'griglia', print_to: ['cibo'],
      composition: { salsicce: 2, polenta: 1 }, initial_stock: 500, alert_threshold: 20 },
    { id: 'costicine_polenta', name: 'Costicine con polenta', price: 7.50, category: 'secondo', station: 'griglia', print_to: ['cibo'],
      composition: { costicine: 3, polenta: 1 }, initial_stock: 500, alert_threshold: 20 },
    { id: 'sovracoscia_polenta', name: 'Sovracoscia di pollo con polenta', price: 7.50, category: 'secondo', station: 'griglia', print_to: ['cibo'],
      composition: { sovracoscia: 1, polenta: 1 }, initial_stock: 500, alert_threshold: 20 },
    { id: 'grigliata_mista', name: 'Grigliata mista con polenta', price: 11.00, category: 'secondo', station: 'griglia', print_to: ['cibo'],
      composition: { costicine: 2, salsicce: 1, sovracoscia: 0.5, polenta: 1 }, initial_stock: 500, alert_threshold: 15 },

    // PIATTI SPECIALI — doppia stampa: .205 (cibo) + .207 (speciali)
    { id: 'pesce_fritto', name: 'Pesce fritto', price: 13.50, category: 'speciale', station: 'speciali', print_to: ['cibo', 'speciali'], special: true, available_date: '2025-05-10',
      initial_stock: 250, alert_threshold: 5 },
    { id: 'coniglio', name: 'Coniglio', price: 15.00, category: 'speciale', station: 'speciali', print_to: ['cibo', 'speciali'], special: true, available_date: '2025-05-11',
      initial_stock: 500, alert_threshold: 5 },
    { id: 'costata', name: 'Costata', price: 25.00, category: 'speciale', station: 'speciali', print_to: ['cibo', 'speciali'], special: true, available_date: '2025-05-16',
      initial_stock: 500, alert_threshold: 3 },
    { id: 'galletto_patate', name: 'Galletto con patate', price: 14.00, category: 'speciale', station: 'speciali', print_to: ['cibo', 'speciali'], special: true, available_date: '2025-05-17',
      initial_stock: 500, alert_threshold: 5 },
    { id: 'trippa', name: 'Trippa', price: 8.50, category: 'speciale', station: 'speciali', print_to: ['cibo', 'speciali'], special: true, available_date: '2025-05-18',
      initial_stock: 500, alert_threshold: 5 },
    { id: 'paella', name: 'Paella', price: 16.00, category: 'speciale', station: 'speciali', print_to: ['cibo', 'speciali'], special: true, available_date: '2025-05-23',
      initial_stock: 500, alert_threshold: 5 },
    { id: 'spiedo', name: 'Spiedo', price: 13.00, category: 'speciale', station: 'speciali', print_to: ['cibo', 'speciali'], special: true, available_date: '2025-05-24',
      initial_stock: 500, alert_threshold: 5 },
    ...
    // CONTORNI
    { id: 'patate_fritte', name: 'Patate fritte', price: 3.00, category: 'contorno', station: 'cucina', print_to: ['cibo'],
      composition: { patate: 1 }, initial_stock: 500, alert_threshold: 20 },
    ...
    { id: 'fagioli_cipolla', name: 'Fagioli con cipolla', price: 2.50, category: 'contorno', station: 'cucina', print_to: ['cibo'],
      initial_stock: 500, alert_threshold: 15 },
    { id: 'cappuccio', name: 'Cappuccio', price: 2.50, category: 'contorno', station: 'cucina', print_to: ['cibo'],
      initial_stock: 500, alert_threshold: 20 },
    { id: 'funghi', name: 'Funghi misto bosco', price: 3.50, category: 'contorno', station: 'cucina', print_to: ['cibo'],
      initial_stock: 500, alert_threshold: 10 },
    ...
    { id: 'vino_bianco_ombra', name: 'Vino ombra bianco', price: 1.00, category: 'bevanda', station: 'bar', print_to: ['bevande'],
      initial_stock: 500, alert_threshold: 30 },
    ...
    { id: 'vino_bianco_trequarti', name: 'Vino bianco sfuso 3/4L', price: 4.00, category: 'bevanda', station: 'bar', print_to: ['bevande'],
      initial_stock: 500, alert_threshold: 8 },
    { id: 'vino_rosso_trequarti', name: 'Vino rosso sfuso 3/4L', price: 4.00, category: 'bevanda', station: 'bar', print_to: ['bevande'],
      initial_stock: 500, alert_threshold: 8 },
    { id: 'prosecco', name: 'Prosecco Superiore DOCG', price: 11.00, category: 'bevanda', station: 'bar', print_to: ['bevande'],
      initial_stock: 500, alert_threshold: 5 },
    { id: 'cabernet', name: 'Bottiglia Cabernet', price: 8.50, category: 'bevanda', station: 'bar', print_to: ['bevande'],
      initial_stock: 500, alert_threshold: 5 },
    ...
    { id: 'acqua_frizzante', name: 'Acqua frizzante 1/2L', price: 1.00, category: 'bevanda', station: 'bar', print_to: ['bevande'],
      initial_stock: 500, alert_threshold: 30 },
    { id: 'the_pesca', name: 'The alla pesca', price: 2.50, category: 'bevanda', station: 'bar', print_to: ['bevande'],
      initial_stock: 500, alert_threshold: 10 },
    { id: 'the_limone', name: 'The al limone', price: 2.50, category: 'bevanda', station: 'bar', print_to: ['bevande'],
      initial_stock: 500, alert_threshold: 10 },
    { id: 'coca_cola', name: 'Coca Cola', price: 2.50, category: 'bevanda', station: 'bar', print_to: ['bevande'],
      initial_stock: 500, alert_threshold: 10 },
    { id: 'coca_zero', name: 'Coca Cola Zero', price: 2.50, category: 'bevanda', station: 'bar', print_to: ['bevande'],
      initial_stock: 500, alert_threshold: 10 },
    { id: 'fanta', name: 'Fanta', price: 2.50, category: 'bevanda', station: 'bar', print_to: ['bevande'],
      initial_stock: 500, alert_threshold: 10 },
  ],
