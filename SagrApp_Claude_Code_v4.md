...
║  ┌──────────────────────────────────────────────────┐   ║
║  │ Stato: ● Connesso                                │   ║
║  │ Mostra: 2 colonne (da cucinare / nello scaldavivande)│   ║
...
- I dispositivi connessi (monitor, scaldavivande, proxy) appaiono automaticamente quando si collegano
...
Pagina dedicata alla gestione di materiali e consumabili (bicchieri, posate, rotoli carta, detersivi, ecc.). Nessun legame con il menu o le casse — articoli indipendenti. L'admin ci va prima dell'apertura per impostare le quantità, e durante il servizio per aggiornamenti rapidi.

**Layout — usa /frontend-design:**

```
╔══════════════════════════════════════════════════════════╗
║  📦 Magazzino — Materiali e consumabili  [CSV][Importa] ║
║                                              [+ Nuovo]  ║
╠══════════════════════════════════════════════════════════╣
║  [Tutti 24] [Posate 8] [Bevande 6] [Pulizia 5] [Altro] ║
╠══════════════════════════════════════════════════════════╣
║                                                          ║
║  ── POSATE ───────────────────────────────────── 8 ──   ║
║  ┌────────────────────────────────────────────────────┐ ║
║  │ 🟢 Forchette plastica     120/200  [-5][-1][+1][+5]│ ║
║  │    Posate · soglia: 20 · 12/04 18:30       [✎][×]  │ ║
║  ├────────────────────────────────────────────────────┤ ║
║  │ 🟡 Coltelli monouso        15/100  [-5][-1][+1][+5]│ ║
║  │    Posate · soglia: 20 · 12/04 18:45       [✎][×]  │ ║
║  └────────────────────────────────────────────────────┘ ║
║                                                          ║
║  ── BEVANDE ──────────────────────────────────── 6 ──   ║
║  ┌────────────────────────────────────────────────────┐ ║
║  │ 🟢 Bicchieri birra         340/500 [-5][-1][+1][+5]│ ║
║  └────────────────────────────────────────────────────┘ ║
╚══════════════════════════════════════════════════════════╝
```
...
- Lista articoli con quantità attuale/totale e **indicatore colorato** (verde/giallo sotto soglia/rosso a zero)
- **Pulsanti rapidi** per aggiornare: [−5] [−1] [+1] [+5] [+10]
- **Click sulla quantità** per impostare valore esatto (input inline)
- **Soglia alert configurabile** per ogni articolo (campo editabile nel modale)
- Pulsante **"+ Nuovo"** per aggiungere un articolo (modale con nome, categoria, quantità, totale, soglia)
- **Categoria** assegnabile a ogni articolo (input con datalist delle categorie esistenti + creazione nuova)
- **CSV Export/Import**: esportazione CSV completa, importazione con merge per nome
- Aggiornamento in tempo reale via Socket.IO (`warehouse_updated`)
- Modifica e eliminazione (con conferma) per ogni articolo
...
13. Gestione magazzino / scorte con pulsanti rapidi — **usa /frontend-design**
14. Dashboard admin LIVE con statistiche real-time — **usa /frontend-design**
15. Dashboard admin RECAP con report, omaggi, sconti e esportazione CSV — **usa /frontend-design**
16. Alert scorte alle casse (WebSocket push)
17. **Alert sonori/visivi per problemi HW + modalità emergenza stampante**
18. **Chiusura turno guidata** — **usa /frontend-design**
19. Test completo automatizzato
20. Polish finale e verifica contrasto/leggibilità
